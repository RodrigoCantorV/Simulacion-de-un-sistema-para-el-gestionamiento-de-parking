...
<link rel="stylesheet" type="text/css" href="../codigo_css2/modelado-guardaS-solicitud-de-personas-internas.css">
...
<form class="parquing" method="POST" action=guardaS-solicitud-de-personas-internas.php>
  <input type="submit"value="MODIFICAR"class="btn btn-warning"name="btn_modific"> 
...
<!--//////////AQUI INICIAMOS CON EL CREACCION DEL FORMCULARIO DE salida de personas internas a la udec/////////////////////-->

<form class ="p-externas" method="POST" action=guardaS-solicitud-de-personas-internas.php>
                                

<input type="submit"value="LIBERAR"class="btn btn-primary"name="btn_modificar"> 
