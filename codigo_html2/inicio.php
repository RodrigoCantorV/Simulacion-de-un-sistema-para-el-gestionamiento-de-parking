<html lang="en">
    <head>
 <link rel="stylesheet" type="text/css" href="../codigo_css2/entornoinicio.css">
    </head>
    <meta charset="UTF-8">
...
<!--/////////////////////////////////////////////////////////////AQUI TERMINAMAS AMAGENES MOVILES////////////////////////////////////////////-->
 ...
 <!--/////////////////////////////////////////////////////////////INICIA NUESTRA PRESENTACION////////////////////////////////////////////-->

        <form class="descripcion">
     <p>Ahora podras ver informacion sobre nuestro estacionamientos, una iniciativa de los ingenieros de sistemas para la comunidad udecina
     y poder asi estar al tanto de todo lo que vaya a suceder en estos espacios. Fomentando el orden, sitematizacion ys obre todo tu seguridad.<p>
        </form>
        <form class="propaganda">
            <p>!PRUEBA YA ESTE NUEVO SERVICIO¡</p>
        </form>


        <form class="foto">
        <div>
        <a href="#"><img src="../fotosUdec/parqueadero.png"></a>
        </div>
        </form>

<!--/////////////////////////////////////////////////////////////ACABA NUESTRA PRESENTACION////////////////////////////////////////////-->
