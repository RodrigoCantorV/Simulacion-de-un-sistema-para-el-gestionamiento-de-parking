...
<link rel="stylesheet" type="text/css" href="../codigo_css2/guardaS-solicitud-de-entrada.css">
...
<form class ="perso_afue" method="POST" action= guardaS-solicitud-de-entrada.php>
...
<form class ="num_solicitud" method="POST" action=guardaS-solicitud-de-entrada.php>
<h1>LIBERAR NUMERO DE SOLICITUD</h1>                                
<input type="submit"value="LIBERAR"class="btn btn-primary"name="btn_modif">  
<br><br>
<table>
<tr>
<td><label for="solicitud"><p>SOLICITUD</p></label></td>
<td><input type="text" name="solicitud" class="form-control" id="solicitud" placeholder="Numero de solicitud"></td>

<td><label for="hora_fin"><p>HORA_FINAL</p></label></td>
<td><input type="text" name="hora_fin" class="form-control" id="hora_fin" placeholder="Escribe la hora final"></td>
...
{
//ACTUALICESE
$conexion->query("UPDATE num_solicitud SET solicitud='$solicitud', hora_fin='$hora_fin' WHERE solicitud='$solicitud'"); 
...
<form class ="datos" method="POST" action=guardaS-solicitud-de-entrada.php>
