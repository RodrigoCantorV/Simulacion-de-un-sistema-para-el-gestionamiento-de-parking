...
<link rel="stylesheet" type="text/css" href="../codigo_css2/modelado_guarda_entrada-b.css">
...
<form class ="perso_afue" method="POST" action= guardaE.php>
<h1>REGISTRO DE PERSONAS EXTERNAS A LA UNIVERSIDAD</h1>                         
<table>
<tr>
<td> <input type="submit"value="REGISTRAR"class="btn btn-primary"name="btn_regis"></td>
<td> <input type="submit"value="CONSULTAR"class="btn btn-primary"name="btn_consult"> </td>
<td> <input type="submit"value="ACTUALIZAR"class="btn btn-primary"name="btn_actualizarr">  </td>
</tr>
