...
<link rel="stylesheet" type="text/css" href="../codigo_css2/modelado-guardaE-solicitud-de-personas-internas-a.css">
...
<form class="parquing" method="POST" action=guardaE-solicitud-de-personas-internas.php>
...
<form class ="p-externas" method="POST" action=guardaE-solicitud-de-personas-internas.php>
...
<td><label for="codigou"><p>CODIGO UDEC<p></label></td>
<td><input type="text" name="codigou" class="form-control" id="codigou" placeholder="Escribe el codigo"></td>
...
<!--//////////INICIO DE BOTON PARA REGISTRAR EL INGRESO DE PERSONAS INTERNAS A LA UDEC///////////////-->
...
}else
{
      ...
      //INSERTAR
  mysqli_query($conexion, "INSERT INTO ingreso (fecha,hora_en,codigou,espacio) values ('$fecha','$hora_en','$codigou','$espacio')"); 
 ...
 ?>
<!--//////////FIN DE BOTON PARA REGISTRAR EL INGRESO DE PERSONAS INTERNAS A LA UDEC///////////////-->
